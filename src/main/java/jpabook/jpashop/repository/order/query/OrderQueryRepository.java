...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrderQueryDtos() {
        ...
        result.forEach(o -> {
            List<OrderItemQueryDto> orderItems = findOrderItems(o.getOrderId());    //  위의 Query 결과 row만큼 loop 돌기 때문에 추가 Query N번
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        ...
        Map<Long, List<OrderItemQueryDto>> orderItemMap = orderItems.stream().collect(Collectors.groupingBy(o -> o.getOrderId()));  // List -> Map으로 변환
        return orderItemMap;
    }
